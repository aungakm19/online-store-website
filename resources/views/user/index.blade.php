          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="text-content">
                <h4>Here you can find most suitable Laptops for you!</h4>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="blog-post">
                <div class="blog-thumb">
                  <img src="{{ asset('user/featuredimages/'. $product['cover']) }}" height="240px" alt="">
                </div>
                <div class="down-content">
                  <span>$ {{ $product['price'] }}</span>
                  <a href="{{ url("/products/featuredproductdetail/$product->id") }}"><h4>{{ $product['name'] }}</h4></a>
                  <div class="post-options">
                    <div class="row">
                      <div class="col-lg-12">
                        <ul class="post-tags">
                          <li><i class="fa fa-bullseye"></i></li>
                          <li><a href="{{ url("/products/featuredproductdetail/$product->id") }}">View Product</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
