                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><button class="btn btn-success btn-sm"><a href="{{ url("/admin/order-history") }}" style="color: white">View Order History</a></button></li>
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <aside class="profile-nav alt">
                            <section class="card">
                                <div class="card-header user-header alt bg-dark">
                                    ...
                                    <div class="media">
                                            <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="{{ asset('/user/images/' .  $orderitem->item->cover) }}">
                                            
                                        <div class="media-body">
                                            <h5 class="text-light">{{ $orderitem->item->name }}</h5>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <span class="badge badge-primary">Name</span>
                                         <span class="pull-right">{{ $userorder['name'] }}</span>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge badge-primary">Email</span>
                                         <span class="pull-right">{{ $userorder['email'] }}</span>
                                    </li><li class="list-group-item">
                                        <span class="badge badge-primary">Phone</span>
                                         <span class="pull-right">{{ $userorder['phone'] }}</span>
                                    </li><li class="list-group-item">
                                        <span class="badge badge-primary">Address</span>
                                        <span class="pull-right">{{ $userorder['address'] }}</span>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="badge badge-primary">Total Price</span>
                                         
                                        <span class="pull-right">$ {{ $orderitem['totalprice'] }}</span>
                                        
                                    </li>
                                    <li class="list-group-item">
                                       
                                        <center><button type="button" class="btn btn-success btn-sm"><a style="color: white" href="{{ url("/admin/status-confirm/$userorder->id") }}"> Mark as deliver</a></button></center>
                    ...
                    @else
                    <div class="card-body">
                        <center><h4 class="card-text">No ordered items!</h4></center>
                    </div>
                    @endif
                </div><!-- .row -->
            </div><!-- .animated -->
