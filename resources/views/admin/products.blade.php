                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><button class="btn btn-success btn-sm"><a href="{{ url("/admin/products/add") }}" style="color: white">Insert Product</a></button></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    <img class="mx-auto d-block" src="{{ asset('/user/images/'. $product['cover']) }}" alt="Card image cap" height="120px">
                                    <h5 class="text-sm-center mt-2 mb-1"><strong>Price = $ {{ $product['price'] }}</strong></h5>
                                </div>
                                <hr>
                                <div class="form-actions form-group">
                                <center>
                                    <button class="btn btn-success btn-sm"><a href="{{ url("/admin/products/edit/$product->id") }}" style="color: white"><i class="fa fa-refresh"></i>   Edit</a></button>
                                
                                    <button class="btn btn-success btn-sm"><a href="{{ url("/admin/products/delete/$product->id") }}" style="color: white"><i class="fa fa-refresh"></i>   Delete</a></button>
                                </center>
                                </div>
                            </div>
                        </div>
