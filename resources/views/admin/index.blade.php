...
<body>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div style="background-color: pink" class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i style="color: purple" class="ti-face-smile"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-digit">ဟိုင်း မင်မင်!</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">စုစုပေါင်းရောင်းရငွေ</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">ပစ္စည်း</div>
                                        <div class="stat-digit">{{ count($products) }}</div>
                                        <br>
                                        <a class="text-success icon-success" href="{{ url("/admin/products") }}"><i class="menu-icon fa fa-play"></i>  ယခုကြည့်ပါ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">ဖောက်သည်</div>
                                        <div class="stat-digit">{{ count($users) }}</div>
                                        <br>
                                        <a class="text-primary icon-primary" href="{{ url("/admin/userinfo") }}"><i class="menu-icon fa fa-play"></i>  ယခုကြည့်ပါ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">အမှာစာ</div>
                                        <div class="stat-digit">{{ count($orderproducts) }}</div>
                                        <br>
                                        <a class="text-warning icon-warning" href="{{ url("/admin/order") }}"><i class="menu-icon fa fa-play"></i>  ယခုကြည့်ပါ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-view-list-alt text-danger border-danger"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">အမျိုးအစား</div>
                                        <div class="stat-digit">{{ count($cats) }}</div>
                                        <br>
                                        <a class="text-danger icon-danger" href="{{ url("/admin/category") }}"><i class="menu-icon fa fa-play"></i>  ယခုကြည့်ပါ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="<?php echo url('/'); ?>/admin/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="<?php echo url('/'); ?>/admin/js/init/fullcalendar-init.js"></script>
