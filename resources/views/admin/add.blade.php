                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">Name<input type="text" name="name" placeholder="Enter product name" class="form-control" required=""></div>
                                <div class="form-group">Specification<input type="text" name="spec" placeholder="Enter specification" class="form-control" required=""></div>
                                <div class="form-group">Price<input type="text" name="price" placeholder="Enter price" class="form-control" required=""></div>
                                ...
                                <div class="row form-group">
                                    <div class="col-12">
                                        <div class="form-group">Description<textarea name="description" class="form-control"></textarea></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-12">
                                        <div class="form-group">Photo<input type="file" name="cover" class="form-control"></div>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-success btn-sm">Insert Product</button>
                            </form>
