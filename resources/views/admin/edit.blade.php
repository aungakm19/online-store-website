        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden" href="./"><img src="<?php echo url('/'); ?>/admin/images/logo2.png" alt="Logo"></a>
        ...
        <div class="breadcrumbs">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Edit</strong><small> Form</small></div>
                            <form method="post" enctype="multipart/form-data">
                                @csrf   
                                <div class="card-body card-block">
                                <div class="form-group">Name<input type="text" name="name" placeholder="Enter product name" class="form-control" value="{{ $product['name'] }}" required=""></div>
                                <div class="form-group">Specification<input type="text" name="spec" placeholder="Enter specification" class="form-control" value="{{ $product['spec'] }}" required=""></div>
                                <div class="form-group">Price<input type="text" name="price" placeholder="Enter price" class="form-control" value="{{ $product['price'] }}" required=""></div>
                                ...
                                <div class="row form-group">
                                    <div class="col-12">
                                        <div class="form-group">Description<textarea name="description" class="form-control">{{ $product['description'] }}</textarea></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <img src="{{ asset('/user/images/' . $product['cover']) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-12">
                                        <div class="form-group">Photo<input type="file" name="cover" class="form-control" required=""></div>
                                    </div>
                                </div>
