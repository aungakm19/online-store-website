                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><button class="btn btn-success btn-sm"><a href="{{ url("/admin/category/add") }}" style="color: white">Insert Category</a></button></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Category Lists</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
                                  ...
                                  <tbody>
                                    ...
                                    <td>{{ $category['name'] }}</td>
                                    <td><button type="submit" class="btn btn-success btn-sm"><a href="{{ url("/admin/category/edit/$category->id") }}" style="color: white">Edit</a></button></td>
                                    <td><button type="submit" class="btn btn-success btn-sm"><a href="{{ url("/admin/category/delete/$category->id") }}" style="color: white">Delete</a></button></td>
                                    </tr>
                                    @endforeach
